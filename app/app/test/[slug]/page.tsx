...
import { passoDopoTest } from "@/lib/percorso/prossimaTappa";
  ...
  if (attempt.stato === "completata" && test.misura === "assi") {
    ...
    return (
      <div className="space-y-6">
        ...
        <EsitoT2 profilo={profilo} assi={assi} spiegazioni={spiegazioni} divergenza={divergenza} prossima={passoDopoTest(slug)} />
      </div>
    );
  }
  ...
  if (attempt.stato === "completata" && test.misura === "aree") {
    ...
    return (
      <div className="space-y-6">
        ...
        <EsitoTest titolo={test.titolo} aree={aree} prossima={passoDopoTest(slug)} />
      </div>
    );
  }
