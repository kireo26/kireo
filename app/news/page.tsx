...
export default async function NewsIndex({
  ...
  const filtrati = categoriaAttiva ? tutti.filter((a) => a.category === categoriaAttiva) : tutti;
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        {filtrati.length === 0 ? (
          ...
          <>
            ...
            <Paginazione paginaCorrente={paginaCorrente} totalePagine={totalePagine} categoria={categoriaAttiva} />
          </>
        )}
      </section>
    </>
