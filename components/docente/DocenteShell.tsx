...
const NAV_ITEMS = [
  { href: "/docente", label: "Home", shortLabel: "Home", icon: IconHome },
  { href: "/docente/webinar", label: "Webinar", shortLabel: "Webinar", icon: IconWebinar },
  { href: "/docente/attestati", label: "Attestati", shortLabel: "Attestati", icon: IconAttestati },
  { href: "/docente/risorse", label: "Risorse", shortLabel: "Risorse", icon: IconRisorse },
  { href: "/docente/profilo", label: "Profilo", shortLabel: "Profilo", icon: IconProfilo },
];

function isAttivo(pathname: string, href: string) {
  return href === "/docente" ? pathname === "/docente" : pathname.startsWith(href);
}
...
function IconWebinar({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" aria-hidden="true">
...
function IconAttestati({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" aria-hidden="true">
      <circle cx="12" cy="9" r="5" strokeWidth="2" />
      <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="m8.5 13.5-1.5 6 5-2.5 5 2.5-1.5-6" />
    </svg>
  );
}

function IconRisorse({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" aria-hidden="true">
      <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M4 19V5a2 2 0 0 1 2-2h6v18H6a2 2 0 0 1-2-2Z" />
...
export default function DocenteShell({ nome, children }: { nome: string; children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-kireo-dark md:flex">
      <aside className="hidden w-60 flex-none flex-col border-r border-white/5 px-4 py-6 md:flex">
        ...
        <nav className="flex flex-1 flex-col gap-1" aria-label="Navigazione area docente">
          {NAV_ITEMS.map((item) => {
      ...
      <div className="flex min-h-screen flex-1 flex-col">
        ...
        <nav
          ...
          aria-label="Navigazione area docente"
        >
          {NAV_ITEMS.map((item) => {
            const attivo = isAttivo(pathname, item.href);
            return (
