      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "da_dove_viene",
              titolo: "Questo numero da dove l'hai preso?",
              tipo: "testo_lungo",
              prompt: "Renzo guarda la tua tabella, appoggia il dito sulla riga della manutenzione e ti chiede: «questo numero qua, da dove l'hai preso?». Rispondi per quella riga, e poi fai lo stesso per tutte le altre: quali te li ha dati lui, quali vengono da un listino o da un sito, quali li hai stimati tu.",
              hint: "Non c'è niente di male nello stimare: c'è qualcosa di male nel non dirlo. Una tabella dove si sa cosa è misurato e cosa è ipotizzato vale il doppio di una dove i numeri sembrano tutti uguali.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Separa i numeri dati da Renzo da quelli stimati, riga per riga?",
            "Dichiara qual è la riga su cui è meno sicuro?",
          ],
        },
        {
          id: "investimento",
          ...
          sezioni: [
            ...
            {
              id: "i_tremila_di_troppo",
              titolo: "Sessantatremila",
              tipo: "testo_lungo",
              prompt: "Rifai la somma di tutto quello che hai messo in tabella e immagina che venga 63.000. Renzo ha detto sessantamila e non un euro di più, e ha già un mutuo. Cosa togli, e cosa perde il progetto quando l'hai tolto?",
              hint: "Si può togliere una bici, o le batterie di scorta, o l'attrezzatura dei rider, o il nano-hub. Ognuna di queste toglie anche qualcosa al piano di qualcun altro — e dirlo è il lavoro, non il contrario.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Dice cosa si perde, non solo cosa si toglie?",
            "La scelta di cosa sacrificare è motivata e non casuale?",
          ],
        },
        {
          id: "break_even",
          ...
          sezioni: [
            ...
            {
              id: "se_il_risparmio_e_meta",
              titolo: "Se fosse la metà",
              tipo: "testo",
              prompt: "Se il risparmio mensile fosse la metà di quello che hai calcolato, in quanti mesi rientra l'investimento? E quel numero è ancora accettabile per Renzo, o è il punto in cui il progetto non conviene più?",
              hint: "Non serve rifare tutto il conto: serve sapere se il tuo piano regge solo nel caso migliore. E se non regge, serve sapere qual è il confine.",
              minCaratteri: 250,
            },
            {
              id: "il_mese_peggiore",
              titolo: "Gennaio",
              tipo: "testo_lungo",
              prompt: "Gennaio: le consegne calano, il freddo taglia l'autonomia delle batterie, e la rata del mutuo scade come tutti i mesi. Quel mese quanto entra e quanto esce? Se esce più di quello che entra, di' di quanto e con che cosa si copre.",
              hint: "Il rientro dell'investimento e i soldi in cassa sono due cose diverse: si può essere in pareggio sull'anno e non avere di che pagare a gennaio. È la differenza che fa chiudere le ditte che avevano i conti giusti.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Sa dire qual è il confine oltre il quale il progetto non conviene?",
            "Distingue il rientro dell'investimento dai soldi in cassa nel mese?",
            "Dice con che cosa si copre lo scoperto di gennaio, e se l'ha chiesto a Renzo?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "il_numero",
              titolo: "Il numero che si ricorda",
              tipo: "testo",
              prompt: "Qual è l'unico numero che Renzo deve ricordarsi uscendo da questa riunione? Scrivilo, e scrivi in una riga perché è quello e non un altro.",
              hint: "Uno solo. Se ne scrivi tre, non se ne ricorda nessuno.",
              minCaratteri: 200,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Il numero scelto è uno solo, e la scelta è motivata?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "perche_li",
              titolo: "Perché proprio lì",
              tipo: "testo",
              prompt: "Per ogni punto che hai scelto: cosa lo rende adatto — la distanza dal centro, le strade che ci arrivano, cosa c'è intorno. Perché lì e non trecento metri più in là.",
              hint: "Il magazzino di Renzo è già in San Salvario. Per gli altri punti pensa a cosa deve avere un posto per essere un hub: un ingresso a livello strada, la corrente, e qualcuno che apre la mattina.",
              minCaratteri: 250,
            },
            {
              id: "il_posto_che_devi_trovare",
              titolo: "L'indirizzo vero",
              tipo: "testo_lungo",
              prompt: "Renzo ti chiede di andare a vedere il posto dove metteresti il primo nano-hub. Cosa c'è a quell'indirizzo, quanto costa al mese in quella zona, e chi te lo affitta? Se non lo sai, di' come lo scopriresti — e cosa succede al piano se in quella zona non si trova niente.",
              hint: "Un hub non è un punto su una mappa: è un box, un garage, il retro di un negozio, un pezzo di magazzino di qualcun altro. Ha un affitto e ha un proprietario. Se non l'hai cercato, dirlo vale più che inventare una cifra.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "La scelta di ogni punto è motivata su cose fisiche, non su una mappa?",
            "Dice cosa costa e chi affitta, o dichiara di non averlo cercato?",
            "C'è una seconda strada se il posto non si trova?",
          ],
        },
        {
          id: "copertura",
          ...
          sezioni: [
            ...
            {
              id: "chi_resta_fuori",
              titolo: "Le zone che non copri",
              tipo: "testo",
              prompt: "Quali zone di Torino la rete non copre, e che fine fanno i clienti che Renzo ha già lì?",
              hint: "Renzo non parte da zero: ha dei clienti, e alcuni sono fuori dal raggio delle bici. Restano al furgone, si perdono, o si servono in un altro modo?",
              minCaratteri: 250,
            },
            {
              id: "la_giornata_del_rider",
              titolo: "Dalle otto alle cinque",
              tipo: "testo_lungo",
              prompt: "Prendi la riga della tua tabella con più consegne al giorno e raccontami quella giornata con gli orari: uscita dall'hub, prime consegne, rientro per ricaricare, pausa, pomeriggio, ultima consegna. Se le consegne che hai scritto non ci stanno dentro la giornata, dillo e correggi il numero.",
              hint: "Conta i minuti veri: fermarsi, legare la bici, salire a un piano, farsi firmare, ripartire. Renzo ti ha già detto di non contargli i sogni — questo è il posto dove si verifica se erano sogni.",
              minCaratteri: 400,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "La giornata è raccontata con gli orari, non a grandi linee?",
            "Il numero della tabella regge al conto, e se non regge viene corretto?",
            "Dice che fine fanno i clienti fuori dal raggio?",
          ],
        },
        {
          id: "giri",
          ...
          sezioni: [
            ...
            {
              id: "le_ore_di_punta",
              titolo: "Le cinque del pomeriggio",
              tipo: "testo",
              prompt: "Fra le cinque e le sette tutti vogliono il pacco e il centro è pieno. Cosa fa la tua rete in quelle due ore, e cosa cambia rispetto al resto della giornata?",
              hint: "Più bici nella stessa zona, o consegne spostate presto, o una fascia che non prometti. Sono scelte diverse e hanno prezzi diversi.",
              minCaratteri: 250,
            },
            {
              id: "il_giro_che_non_torna",
              titolo: "Martedì alle 16:40",
              tipo: "testo_lungo",
              prompt: "Martedì alle 16:40 un rider ha ancora sette consegne e l'hub chiude alle 18. Cosa succede a quelle sette? E quante volte al mese, secondo te, capita — con che numero lo dici?",
              hint: "Le strade sono poche: restano a domani, le prende un altro rider, le fa il furgone, o si allunga la giornata di qualcuno. Ognuna ha un costo, e una di queste è quella che Renzo teme.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Dice cosa succede alle consegne che restano, e quando lo sa il cliente?",
            "Mette un numero alla frequenza e dichiara da dove viene?",
            "Nelle ore di punta sceglie, invece di promettere tutto?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "cosa_promette",
              titolo: "Quello che puoi promettere, e quello che no",
              tipo: "testo",
              prompt: "Renzo teme una cosa sola: che il pacco arrivi più tardi e il cliente cambi corriere. Qual è la promessa che puoi fargli e mantenere? E quale non puoi fargli?",
              hint: "Due frasi bastano. La seconda è la più importante: un corriere che promette tutto è un corriere che deluderà su qualcosa.",
              minCaratteri: 250,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "È coerente con le tappe precedenti?",
            "C'è anche la promessa che NON si può fare, non solo quella che si può?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "cosa_non_serve",
              titolo: "Quello che hai lasciato fuori",
              tipo: "testo",
              prompt: "Quali funzioni hai deciso di non mettere, e perché. Almeno due.",
              hint: "Mappe con i mezzi che si muovono in diretta, statistiche, chat interne: sono le cose che si vedono nelle demo e che in una ditta da tre furgoni non apre nessuno. Dire cosa togli è una scelta di progetto, non una mancanza.",
              minCaratteri: 250,
            },
            {
              id: "le_prime_tre_consegne",
              titolo: "Il primo lunedì",
              tipo: "testo_lungo",
              prompt: "Primo lunedì col sistema. Un rider esce dall'hub con trenta pacchi. Racconta cosa tocca sullo schermo dalla prima consegna alla terza: quante volte tira fuori il telefono, per fare cosa, e con i guanti addosso.",
              hint: "Ogni tocco in più è un motivo per non usarlo. Se una consegna richiede sei passaggi, scrivi sei — e poi guarda se ne bastano tre.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Conta i tocchi veri sullo schermo, o descrive funzioni?",
            "Tiene conto di chi lo usa in strada, con i guanti e di fretta?",
            "Le funzioni scartate sono almeno due, con una ragione?",
          ],
        },
        {
          id: "sistema",
          ...
          sezioni: [
            ...
            {
              id: "come_si_fa_oggi",
              titolo: "Il quaderno di Renzo",
              tipo: "testo",
              prompt: "Oggi, senza nessun sistema, come fa Renzo a sapere cosa è stato consegnato e cosa no? Descrivi il giro di informazioni così com'è adesso.",
              hint: "Renzo l'ha detto: i pacchi li segna sul quaderno. Quindi c'è un quaderno, ci sono delle telefonate, e c'è qualcosa che si perde. Prima di sostituire un modo di lavorare bisogna saperlo raccontare.",
              minCaratteri: 250,
            },
            {
              id: "il_giovedi_senza_sistema",
              titolo: "Giovedì alle nove",
              tipo: "testo_lungo",
              prompt: "Giovedì mattina alle nove il sistema non carica i giri. I rider sono in hub con i pacchi già caricati. Cosa si fa, chi decide, e dopo quanto si decide?",
              hint: "La domanda vera non è se succederà: è se qualcuno sa cosa fare quando succede. Se la risposta è «si torna al quaderno», allora il quaderno va tenuto — e va detto dove sta.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Racconta il modo di lavorare di oggi prima di sostituirlo?",
            "Nel guasto c'è chi decide e dopo quanto, o solo cosa si fa?",
            "Ammette che il cartaceo va tenuto, invece di deriderlo?",
          ],
        },
        {
          id: "risparmio",
          ...
          sezioni: [
            ...
            {
              id: "chi_cambia_abitudine",
              titolo: "Chi deve cambiare come lavora",
              tipo: "testo",
              prompt: "Chi, fra Renzo e i rider, deve cambiare di più il proprio modo di lavorare? E chi secondo te farà più resistenza?",
              hint: "Di solito non è chi paga: è chi lo usa trenta volte al giorno. Nominare chi farà resistenza non è mancargli di rispetto, è l'unico modo per aiutarlo.",
              minCaratteri: 250,
            },
            {
              id: "i_minuti_veri",
              titolo: "Una consegna, con e senza",
              tipo: "testo_lungo",
              prompt: "Prendi una consegna sola. Racconta cosa succede oggi — dal momento in cui il pacco esce dall'hub a quando Renzo sa che è arrivato — e poi cosa succede col sistema. Metti i minuti a tutti e due. Se il risparmio è più piccolo di quello che avevi scritto nella sezione sopra, correggi il numero.",
              hint: "I minuti che si risparmiano davvero non sono quelli del rider: sono quelli di Renzo la sera, che telefona per capire cosa è arrivato. Conta anche quelli.",
              minCaratteri: 400,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "I due percorsi sono raccontati con i minuti, non a sensazione?",
            "Se il risparmio dichiarato prima era più grande, viene corretto?",
            "Nomina chi farà resistenza, e non solo chi ci guadagna?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "cosa_non_deve_imparare",
              titolo: "Quello che non deve imparare",
              tipo: "testo",
              prompt: "Renzo non è un tecnico e non vuole diventarlo. Qual è la cosa che NON deve imparare, perché il sistema la fa da sola? E qual è l'unica che invece deve imparare per forza?",
              hint: "Rispondi con due frasi. La seconda conta più della prima: un sistema che non chiede di imparare niente è un sistema che qualcuno sta vendendo.",
              minCaratteri: 250,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "È coerente con le tappe precedenti?",
            "C'è anche la cosa che Renzo deve imparare per forza?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "come_l_hai_contata",
              titolo: "Con che conto",
              tipo: "testo",
              prompt: "Scrivi la formula che hai usato: da quanti litri di gasolio parti, con che fattore li hai trasformati in CO₂, e dove hai preso quel fattore.",
              hint: "Un chilo di CO₂ per litro non è un numero che si inventa: sta nelle tabelle ufficiali, ed è diverso per gasolio, benzina e metano. Se il fattore non l'hai cercato, dillo.",
              minCaratteri: 250,
            },
            {
              id: "e_le_batterie",
              titolo: "E le batterie?",
              tipo: "testo_lungo",
              prompt: "Un cliente attento ti chiede: «e la CO₂ per costruire le bici e le batterie, l'avete contata?». Cosa rispondi? E cosa altro non c'è dentro la tua stima?",
              hint: "Costruire una batteria emette, e smaltirla anche. La corrente per ricaricare viene da una presa che a sua volta ha una sua CO₂. Non devi rifare il conto: devi dire cosa il tuo numero copre e cosa no, prima che te lo chieda qualcun altro.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Il fattore di emissione ha una fonte, o è inventato?",
            "Dichiara il perimetro: cosa il numero copre e cosa no?",
            "Distingue quello che ha misurato da quello che gli ha detto Renzo?",
          ],
        },
        {
          id: "bandi",
          ...
          sezioni: [
            ...
            {
              id: "prima_di_presentare",
              titolo: "Cosa serve avere in mano",
              tipo: "testo",
              prompt: "Per il bando che hai scelto: cosa deve avere Renzo prima di poter presentare — documenti, requisiti dell'azienda, preventivi, date. E quanto tempo ci vuole a metterlo insieme.",
              hint: "Quasi tutti i bandi chiedono cose che richiedono settimane: un DURC, un preventivo firmato, una visura. Un bando che scade fra dieci giorni e chiede tre settimane di carte è un bando perso.",
              minCaratteri: 250,
            },
            {
              id: "bando_scartato",
              titolo: "Quello che hai escluso",
              tipo: "testo_lungo",
              prompt: "Fra i bandi che hai guardato, uno l'hai lasciato fuori. Quale, e per quale requisito preciso Renzo non ci rientra? Se invece ci rientrerebbe ma hai scelto un altro, di' perché.",
              hint: "Serve il nome del bando e la riga che lo esclude, non «non era adatto». È la differenza fra aver guardato e aver letto.",
              minCaratteri: 300,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Il bando scartato ha un nome e una riga precisa che lo esclude?",
            "I tempi per mettere insieme i documenti sono realistici?",
          ],
        },
        {
          id: "vantaggio",
          ...
          sezioni: [
            ...
            {
              id: "a_chi_interessa",
              titolo: "Chi lo paga davvero",
              tipo: "testo",
              prompt: "Quali clienti di Renzo sono disposti a pagare qualcosa in più — o a sceglierlo invece di un altro — per la consegna in bici? E quali no?",
              hint: "Un negozio di prodotti biologici in centro e un magazzino di ricambi non ragionano allo stesso modo. E le gare pubbliche sono un terzo caso ancora.",
              minCaratteri: 250,
            },
            {
              id: "se_renzo_ha_ragione",
              titolo: "Non gliene frega niente",
              tipo: "testo_lungo",
              prompt: "Renzo ti dice: «ai miei clienti dell'e-commerce non gliene frega niente dell'ambiente. Vogliono il pacco domani e che costi poco». Ha ragione? E se ha ragione, cosa resta in piedi di tutto quello che hai scritto in questo ruolo?",
              hint: "Potrebbe avere ragione su quei clienti e torto su altri. E anche se avesse ragione su tutti, qualcosa resta — ma è una cosa diversa da quella che stavi vendendo.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Dà ragione al cliente dove ce l'ha, invece di difendere il proprio lavoro?",
            "Quello che resta in piedi è elencato e messo in ordine di solidità?",
            "Distingue i clienti che pagano da quelli a cui non interessa?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "cosa_puo_scrivere",
              titolo: "Quello che può scrivere",
              tipo: "testo",
              prompt: "Cosa può scrivere Renzo sul suo sito, o in fondo a un preventivo, senza dire una cosa falsa? Scrivi la frase esatta, e poi scrivi una frase che invece NON può usare.",
              hint: "«Consegne a zero emissioni in centro» e «siamo un corriere a zero emissioni» non sono la stessa cosa, e la seconda è falsa finché resta un furgone.",
              minCaratteri: 250,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "È coerente con le tappe precedenti?",
            "C'è la frase esatta che si può scrivere E quella che non si può?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "a_chi",
              titolo: "Chi sono questi ragazzi",
              tipo: "testo",
              prompt: "Chi sono gli allievi che immagini: che età, da dove arrivano, e quanti di loro uno strumento ce l'hanno già in casa.",
              hint: "Non «i giovani del quartiere». Un ragazzino di undici anni che va alle medie qui sotto e uno di diciassette che ha già una band sono due persone diverse, e non vogliono la stessa lezione. E chi lo strumento non ce l'ha non può esercitarsi a casa: cambia tutto.",
              minCaratteri: 250,
            },
            {
              id: "la_madre_che_non_ce_la_fa",
              titolo: "Venti euro al mese",
              tipo: "testo_lungo",
              prompt: "Una madre del rione ti chiede quanto costa mandare il figlio a chitarra. Le dici la tua tariffa. Lei fa il conto di quanto è al mese e ti dice che non ce la fa. Cosa le rispondi?",
              hint: "«C'è la borsa di studio» è una risposta solo se la borsa esiste, ha dei posti e qualcuno decide chi la prende. Se non l'hai ancora costruita, questa è la conversazione in cui te ne accorgi — e quello che le dici adesso è quello che dirai a tutte le altre.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Dice una frase vera a quella madre, o si nasconde dietro un principio?",
            "Se nomina borse o riduzioni, dice se esistono già o no?",
          ],
        },
        {
          id: "palinsesto",
          ...
          sezioni: [
            ...
            {
              id: "chi_viene_la_sera",
              titolo: "Chi c'è, la sera",
              tipo: "testo",
              prompt: "Alle serate della scuola chi ci viene: gli allievi, i loro genitori, la gente del rione, gente da fuori? E per ognuno, perché ci verrebbe.",
              hint: "Sono pubblici diversi e non vogliono la stessa serata. Il saggio degli allievi lo riempiono i parenti e non torna nessun altro; un concerto buono porta gente da fuori che alla scuola non si iscriverà mai. Sapere chi stai chiamando è metà del lavoro.",
              minCaratteri: 250,
            },
            {
              id: "la_serata_che_ciro_non_vuole",
              titolo: "Ottanta persone e trecento euro",
              tipo: "testo_lungo",
              prompt: "Un'associazione ti propone una serata con un gruppo bravo: ingresso a offerta libera, bar aperto gestito da loro. Porterebbe ottanta persone e circa trecento euro alla scuola. È il tipo di sera che Ciro ha detto di non volere. Accetti? Se dici di no, cosa dici all'associazione — e cosa perdi?",
              hint: "Trecento euro sono quindici lezioni gratis a un ragazzino. Dire di no a un principio è facile; dire di no a quei soldi è un'altra cosa, e la risposta onesta dice quanto costa il principio.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Mette un numero accanto al costo della scelta, o rispetta il vincolo a gratis?",
            "Dice cosa risponde all'associazione, non solo cosa decide?",
          ],
        },
        {
          id: "tariffe",
          ...
          sezioni: [
            ...
            {
              id: "chi_paga_pieno",
              titolo: "Chi paga tutto",
              tipo: "testo",
              prompt: "Chi sono quelli che la tariffa piena la pagano senza problemi, e quanti pensi che siano rispetto al totale?",
              hint: "In un rione non è vero che nessuno può pagare: ci sono famiglie che pagano una piscina o un'altra scuola di musica e verrebbero qui se la qualità c'è. Sono quelli che tengono in piedi i posti degli altri, e vanno nominati senza vergogna.",
              minCaratteri: 250,
            },
            {
              id: "quanti_ne_servono",
              titolo: "Il conto di un mese",
              tipo: "testo_lungo",
              prompt: "Fai il conto di un mese normale: quanto esce (maestri, affitto, utenze, strumenti) e quanti allievi paganti servono per coprirlo. Poi di' quanti posti restano, con quel numero, per chi non paga. Se sono meno di quanti ne avevi promessi, correggi la promessa.",
              hint: "È la domanda di Ciro — «e questo chi lo paga?» — fatta con i numeri. Il numero dei gratuiti non lo decide la buona volontà: lo decide quanti paganti ci sono. Scoprirlo adesso costa meno che scoprirlo a gennaio.",
              minCaratteri: 400,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Il conto arriva a un numero di paganti, non a un giudizio?",
            "Se la promessa della tappa 1 non regge, la corregge esplicitamente?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "cosa_non_e",
              titolo: "Quello che questa scuola non è",
              tipo: "testo",
              prompt: "Scrivi la frase che dice cosa questa scuola non è — quella che servirà fra due anni, quando arriverà un'offerta che la snatura e qualcuno dovrà dire di no.",
              hint: "Una frase sola, che si possa ripetere a memoria. Ciro l'ha già quasi detta; il tuo lavoro è metterla in una forma che regga anche quando lui non c'è nella stanza.",
              minCaratteri: 250,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "I conti reggono?",
            "È coerente con le tappe precedenti?",
            "La frase è verificabile guardando cosa succede, o è un valore?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "la_sala_che_cambia",
              titolo: "La stessa stanza, due mestieri",
              tipo: "testo",
              prompt: "La sala grande di giorno è un'aula e la sera è un posto dove si suona davanti alla gente. Cosa cambia fisicamente fra le due: cosa si sposta, cosa si copre, cosa resta.",
              hint: "Non «è flessibile». Sedie, leggii, l'ampli, il pianoforte se c'è: le cose hanno un peso e un posto dove stare quando non servono. Se non c'è quel posto, restano in mezzo.",
              minCaratteri: 250,
            },
            {
              id: "le_tre_ore_in_mezzo",
              titolo: "Martedì, dalle 18 alle 21",
              tipo: "testo_lungo",
              prompt: "Martedì alle 18 c'è lezione di chitarra nella sala grande. Alle 21 c'è un concerto. Racconta le tre ore in mezzo: chi sposta cosa, dove vanno le sedie dell'aula, chi monta l'impianto, e a che ora deve finire la lezione perché si faccia in tempo.",
              hint: "Il conto lo fa il tempo, non le buone intenzioni. Se il cambio richiede un'ora e mezza, la lezione del martedì non finisce alle 19: finisce alle 19 e mezza al massimo, e questo toglie un'ora di lezione a qualcuno ogni settimana.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "C'è un orario vero, con chi fa cosa, non «si riorganizza»?",
            "Dice chi paga il cambio — quale lezione si accorcia o si sposta?",
          ],
        },
        {
          id: "acustica",
          ...
          sezioni: [
            ...
            {
              id: "quanto_costa_il_minimo",
              titolo: "Il minimo indispensabile, con i prezzi",
              tipo: "tabella",
              prompt: "Per ogni stanza da trattare: cosa ci metti, quanto costa, e quanto di quel trattamento è indispensabile contro quanto è «meglio se c'è».",
              hint: "Ciro ha venticinquemila euro per tutto, non per l'acustica. L'ultima colonna è quella che conta: se domani il budget si taglia, si deve sapere cosa salta per primo senza rifare il ragionamento.",
              colonne: ["Dove", "Cosa ci metto", "Quanto costa", "Quanto serve davvero"],
              minRighe: 3,
            },
            {
              id: "il_vicino_che_suona_il_campanello",
              titolo: "Le nove di sera",
              tipo: "testo_lungo",
              prompt: "Un vicino del piano di sopra suona il campanello alle nove di sera, durante una prova, e dice che così non si può andare avanti. Cosa fai in quel momento — e cosa avevi fatto prima perché quella sera non arrivasse?",
              hint: "La seconda domanda è quella vera. Una persona che suona il campanello alle nove non è la prima volta che ci pensa: è la terza o la quarta, ed è arrivata lì perché nelle prime tre non aveva nessuno a cui dirlo.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "La colonna «quanto serve davvero» distingue davvero, o è tutto indispensabile?",
            "La parte «prima» esiste, ed è fatta di persone e non solo di pannelli?",
          ],
        },
        {
          id: "identita",
          ...
          sezioni: [
            ...
            {
              id: "chi_lo_fa",
              titolo: "Chi la fa, questa identità",
              tipo: "testo",
              prompt: "Chi realizza materialmente le cose che rendono il posto della Sanità: chi dipinge, chi costruisce, chi presta. Nomina il tipo di persona e cosa gli chiedi.",
              hint: "Ciro ha detto «artisti del rione», e nel rione ce ne sono davvero. Ma un artista che ti fa un muro gratis lo fa una volta: se gli chiedi di farlo, digli cosa ci guadagna e per quanto tempo lo stai impegnando.",
              minCaratteri: 250,
            },
            {
              id: "ma_e_un_deposito",
              titolo: "Una madre entra e dice: ma è un deposito",
              tipo: "testo_lungo",
              prompt: "Una madre entra per la prima volta, si guarda intorno e dice: «ma è un deposito». Cosa vede che le fa dire così? E cosa cambi — sapendo che alcune di quelle cose sono proprio quelle che lo rendono del rione?",
              hint: "Ciro vuole un posto della Sanità e non una cosa che potrebbe stare a Milano. Ma una madre deve poterci lasciare un figlio di undici anni per due ore, e quello che lei guarda è se è pulito, se è illuminato, se c'è un bagno. Le due cose non sono in contraddizione dappertutto: di' dove lo sono e cosa scegli lì.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Separa quello che cambia da quello che tiene, e dice perché?",
            "Nomina il punto preciso dove il desiderio di Ciro e quello della madre si scontrano?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "cosa_non_si_puo_fare_qui",
              titolo: "Le cose che qui non si potranno fare",
              tipo: "testo",
              prompt: "In questo spazio ci sono cose che non si potranno fare, e Ciro deve saperle prima di firmare, non dopo. Quali, e perché.",
              hint: "Una batteria dopo una certa ora. Un concerto oltre un certo numero di persone. Due cose insieme in due stanze diverse. Non sono fallimenti del progetto: sono i confini di centoventi metri in un condominio, e dirli adesso è quello che evita una discussione fra un anno.",
              minCaratteri: 250,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "È coerente con le tappe precedenti?",
            "I limiti sono specifici di questo spazio, con numeri e orari?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "la_prima_lezione",
              titolo: "I primi quaranta minuti",
              tipo: "testo",
              prompt: "Un ragazzino di undici anni che non ha mai toccato uno strumento entra alla sua prima lezione. Racconta quei quaranta minuti: cosa fa per prima cosa, quando tocca lo strumento, e cosa si porta a casa.",
              hint: "Se la prima cosa è il solfeggio, la seconda lezione non c'è. Se la prima cosa è suonare una nota che suona bene, c'è. Non è una scelta di metodo: è la differenza fra chi torna e chi no.",
              minCaratteri: 250,
            },
            {
              id: "quello_che_non_tiene_il_tempo",
              titolo: "La terza lezione",
              tipo: "testo_lungo",
              prompt: "Alla terza lezione collettiva un ragazzino di dodici anni è l'unico del gruppo che non riesce a tenere il tempo. Gli altri se ne accorgono. Cosa fa il maestro in quel momento? E cosa avevi previsto prima perché quel momento fosse gestibile?",
              hint: "Ciro l'ha detto con parole sue: «non voglio che se sente 'nu pesce fuor d'acqua e mo' lla'». Il problema non è che non tiene il tempo: è che se ne accorgono gli altri, e a dodici anni quello conta più della musica.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "C'è una cosa prevista prima, non solo una reazione sul momento?",
            "Dice dove quella previsione non arriva, con i numeri di maestri e ore?",
          ],
        },
        {
          id: "inclusione",
          ...
          sezioni: [
            ...
            {
              id: "gli_strumenti_dove_stanno",
              titolo: "Quanti sono e chi li tiene",
              tipo: "tabella",
              prompt: "Gli strumenti che la scuola presta: quanti, di che tipo, da dove arrivano e chi li tiene in ordine.",
              hint: "Una chitarra prestata a un ragazzino di undici anni torna con le corde rotte, ed è normale. Un set di corde costa otto euro e qualcuno le deve montare. Se non c'è quel qualcuno, dopo sei mesi gli strumenti sono tutti inservibili e nessuno se n'è accorto.",
              colonne: ["Strumento", "Quanti", "Da dove arrivano", "Chi li ripara"],
              minRighe: 3,
            },
            {
              id: "la_chitarra_che_non_torna",
              titolo: "Quattro mesi, e poi sparisce",
              tipo: "testo_lungo",
              prompt: "Un ragazzino ha in prestito una chitarra da quattro mesi. Smette di venire e la chitarra resta a casa sua. Cosa fai?",
              hint: "Le strade sono tre e sono tutte vere: la vai a chiedere, la lasci perdere, o avevi fatto qualcosa prima perché la cosa non si mettesse così. La prima costa un rapporto in un rione dove ci si conosce; la seconda costa duecento euro e il prossimo strumento; la terza va progettata adesso, non dopo.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "La colonna «chi li ripara» ha una persona, o resta vuota e lo dice?",
            "Decide prima cosa si fa, invece di decidere davanti al caso?",
          ],
        },
        {
          id: "percorsi",
          ...
          sezioni: [
            ...
            {
              id: "il_saggio_a_chi_serve",
              titolo: "Il saggio, per chi è",
              tipo: "testo",
              prompt: "Il saggio di fine anno: a chi serve davvero — ai ragazzi, ai genitori o alla scuola? E cosa cambieresti se servisse solo a uno dei tre.",
              hint: "Sono tre cose diverse. Per un ragazzo è la prima volta che qualcuno lo ascolta sul serio. Per un genitore è la prova che i soldi sono serviti a qualcosa. Per la scuola è il giorno in cui il quartiere entra dentro. Se non si sceglie, si fa un saggio che non serve bene a nessuno dei tre.",
              minCaratteri: 250,
            },
            {
              id: "quanti_ce_ne_sono_a_maggio",
              titolo: "Dieci a ottobre",
              tipo: "testo_lungo",
              prompt: "Su dieci ragazzini che cominciano a ottobre, quanti ci sono ancora a maggio? Metti un numero, di' da dove lo tiri fuori, e di' in che mese se ne vanno e perché.",
              hint: "Non è una domanda sul tuo progetto: è una domanda su come vanno queste cose. Se il numero che metti è otto o nove, non hai mai visto un corso vero. E il mese in cui se ne vanno non è a caso — c'è quasi sempre un punto preciso in cui la novità finisce e la fatica no.",
              minCaratteri: 400,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Sceglie UNO dei tre destinatari e ne trae una conseguenza sul formato?",
            "Il numero ha una provenienza dichiarata, e i mesi hanno una ragione?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "chi_smette_cosa_si_porta",
              titolo: "Quello che si porta via chi smette",
              tipo: "testo",
              prompt: "Un ragazzo che smette dopo otto mesi cosa si porta via? Rispondi come se lo dovessi dire a lui, non a Ciro.",
              hint: "Ciro pensa che la musica cambi la vita, e per qualcuno è vero. Ma la maggior parte smette, e una scuola che ha senso solo per chi arriva in fondo ha senso per pochissimi. Se la risposta è «niente», il progetto ha un problema che non è didattico.",
              minCaratteri: 250,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "È coerente con le tappe precedenti?",
            "Parla al ragazzo, e nomina cose che ha fatto davvero?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "chi_puo_dirgli_di_no",
              titolo: "Chi può decidere contro di lui",
              tipo: "testo_lungo",
              prompt: "Ciro ti ha detto: «basta che non me trovo soci che decidono al posto mio». Nella forma che hai scelto, chi può prendere una decisione contro la sua volontà, e in quale situazione concreta? Se la risposta è «nessuno», di' cosa si perde in cambio.",
              hint: "Un'assemblea di soci vota. Un consiglio direttivo può revocare un presidente. Una forma senza nessuno che possa dirgli di no è quasi sempre una forma che ai bandi non accede. Le due cose non si possono avere tutte e due, e il tuo mestiere è dirgli quale sta comprando.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Nomina situazioni concrete in cui qualcuno lo può mettere in minoranza?",
            "Dice il prezzo dell'alternativa, invece di rassicurarlo?",
          ],
        },
        {
          id: "bandi",
          ...
          sezioni: [
            ...
            {
              id: "cosa_non_pagano",
              titolo: "Quello che nessun bando paga",
              tipo: "testo",
              prompt: "Per i bandi che hai messo in tabella: cosa coprono davvero, e soprattutto cosa non coprono.",
              hint: "Quasi nessun bando paga gli affitti e quasi nessuno paga gli stipendi continuativi. Pagano attrezzature, progetti a termine, attività con una data di inizio e una di fine. Se le spese che restano scoperte sono quelle che tornano ogni mese, il problema è più grosso del bando.",
              minCaratteri: 250,
            },
            {
              id: "e_se_quest_anno_non_esce",
              titolo: "Ma so' veri?",
              tipo: "testo_lungo",
              prompt: "Ciro ti ha chiesto se sono veri. Prendi il bando su cui il tuo piano conta di più: dove l'hai letto, quando è uscita l'ultima edizione, chi lo pubblica. E poi: cosa succede al progetto se quest'anno non esce?",
              hint: "Un bando che è uscito per tre anni di fila esce quasi sempre anche il quarto — quasi. Un bando citato perché «di solito c'è» non è un'entrata: è una speranza con un nome. La seconda domanda è quella vera, e la risposta non può essere «ne cerchiamo un altro».",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Distingue le spese ricorrenti da quelle a progetto?",
            "Dice dove ha letto il bando, e cosa regge senza di lui, voce per voce?",
          ],
        },
        {
          id: "siae",
          ...
          sezioni: [
            ...
            {
              id: "quanto_a_serata",
              titolo: "Il conto di una serata",
              tipo: "tabella",
              prompt: "Metti giù cosa si paga per una serata di concerto, voce per voce, e segna quali costi ci sono sempre e quali solo in certi casi.",
              hint: "SIAE, che cambia se l'ingresso è gratuito o a pagamento e se l'ente è no profit. Eventuale SCIA o comunicazione al Comune. L'assicurazione, che di solito è annuale e non a serata. Distinguere il fisso dal variabile è quello che permette di decidere quanti concerti fare.",
              colonne: ["Voce", "Quanto", "Si paga sempre?"],
              minRighe: 3,
            },
            {
              id: "quanti_concerti_si_possono_fare",
              titolo: "Quanti ne reggiamo",
              tipo: "testo_lungo",
              prompt: "Fai il conto di un anno: con i costi che hai messo, quanti concerti si possono fare davvero? Confronta quel numero con quelli che il palinsesto della scuola prevede. Se sono meno, dillo — e di' cosa salta.",
              hint: "Ciro l'ha detto chiaro: «se ogni volta è 'nu salasso, i concerti non li faccio proprio». È il posto dove si scopre se il calendario che ha disegnato qualcun altro sta in piedi con i soldi veri, e dirlo adesso costa molto meno che scoprirlo a marzo.",
              minCaratteri: 400,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Separa il costo fisso annuale da quello a serata?",
            "Confronta il proprio numero con il palinsesto, e ne trae una conseguenza per chi l'ha scritto?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "cosa_non_puo_piu_disfare",
              titolo: "Quello che poi non si torna indietro",
              tipo: "testo",
              prompt: "Ciro deve firmare qualcosa per far nascere tutto questo. Cosa firma, a cosa si impegna per legge, e qual è la cosa che dopo non potrà più disfare facilmente?",
              hint: "Sciogliere un'associazione non è come chiudere una partita IVA, e il patrimonio di un ente no profit non torna a chi l'ha messo. Non è un motivo per non farlo: è un motivo per saperlo prima di firmare, e nessuno glielo dirà se non lo fai tu.",
              minCaratteri: 250,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "È coerente con le tappe precedenti?",
            "Nomina una conseguenza irreversibile precisa, non «è un impegno serio»?",
          ],
        },
      ],
    },
      ...
      fasi: [
        {
          ...
          sezioni: [
            ...
            {
              id: "il_quartiere",
              titolo: "Chi muove già gente, qui",
              tipo: "tabella",
              prompt: "Nel rione c'è già chi muove persone intorno alla musica o intorno ai ragazzi. Elencali: cosa fanno, quante persone toccano, e cosa potrebbe passare fra loro e la scuola — in un verso o nell'altro.",
              hint: "Non «le associazioni del territorio». La parrocchia con il coro, la scuola media qui sotto, il centro sociale, la banda, il maestro che dà lezioni private a casa sua. Se non sai i nomi, scrivi il tipo e quante persone muove — un numero approssimativo scritto vale più di una categoria esatta.",
              colonne: ["Chi", "Cosa fa già", "Quante persone muove", "Cosa può darti / cosa gli togli"],
              minRighe: 4,
            },
            {
              id: "chi_non_ti_conosce",
              titolo: "Sei mesi dopo, a duecento metri",
              tipo: "testo_lungo",
              prompt: "Sono passati sei mesi dall'apertura. Una donna che abita a duecento metri, con un figlio di dodici anni, non ha mai sentito nominare la scuola. Non è una che non esce di casa: è una a cui l'informazione non è arrivata. Per quali persone e quali posti passa quello che lei sa? E quale di quei passaggi non hai toccato?",
              hint: "«Non abbiamo comunicato abbastanza» non è una risposta: è il modo di non darla. In un rione un'informazione passa per persone — la maestra, la farmacia, il gruppo dei genitori della classe, la salumeria, il barbiere — e per quasi nessun manifesto. Scegline uno che ti è mancato e di' perché ti è mancato.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "L'ultima colonna dice anche cosa si toglie a qualcuno, o solo cosa si guadagna?",
            "Nomina un canale mancato preciso e la ragione vera per cui è mancato?",
          ],
        },
        {
          id: "alleati",
          ...
          sezioni: [
            ...
            {
              id: "la_scuola_pubblica",
              titolo: "Mezz'ora con la preside",
              tipo: "testo",
              prompt: "Hai mezz'ora con la preside delle medie qui sotto. Cosa le chiedi di concreto, e cosa le offri in cambio?",
              hint: "«Collaborazione» non è una cosa che si chiede: è una cosa che si chiama così dopo. Mettere un foglio nello zaino di trecento ragazzini è una cosa. Due pomeriggi l'anno in palestra è un'altra. E la preside ha un problema suo — i ragazzi che alle tre non sanno dove andare: se la tua richiesta risolve anche quello, hai qualcosa da offrire e non stai solo chiedendo.",
              minCaratteri: 250,
            },
            {
              id: "il_maestro_che_ci_perde",
              titolo: "Al bar, quello a cui stai levando il pane",
              tipo: "testo_lungo",
              prompt: "Nel rione c'è un maestro che dà lezioni private a casa sua: quindici euro l'ora, una ventina di allievi. Voi fate corsi collettivi che costano molto meno. Lo incontri al bar e ti dice che gli state levando il pane. Cosa gli rispondi — e cosa cambia davvero nel tuo piano dopo quella conversazione, se cambia qualcosa?",
              hint: "Le due risposte comode sono tutte e due false. «Non ti togliamo niente» non è vero: qualche allievo glielo togliete. «Vieni a insegnare da noi» detto senza dire a quanto l'ora e per quante ore è una frase per chiudere il discorso, non un'offerta. E se decidi che qualche allievo glielo togli e va bene così, scrivilo: è una risposta legittima, a patto di dirla e non di girarci intorno.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "La richiesta alla preside è una cosa sola e concreta, con qualcosa in cambio?",
            "Ammette cosa toglie al maestro, e dice cosa cambia o non cambia nel piano?",
          ],
        },
        {
          id: "far_conoscere",
          ...
          sezioni: [
            ...
            {
              id: "i_primi_tre_mesi",
              titolo: "Chi lo fa, in quante ore",
              tipo: "tabella",
              prompt: "I tre mesi prima dell'apertura, uno per uno: cosa si fa, chi lo fa materialmente, quante ore costa e quanti euro.",
              hint: "«Volantini» non è una riga: la riga è «qualcuno sta tre ore davanti alla scuola media all'uscita, tre giorni di fila». Le ore contano più degli euro, perché in un progetto così le ore delle persone finiscono prima dei soldi, e sono quelle che nessuno mette nelle tabelle.",
              colonne: ["Mese", "Cosa fai", "Chi lo fa", "Ore", "Euro"],
              minRighe: 6,
            },
            {
              id: "come_lo_sai",
              titolo: "Il numero a cui ammetti che non sta funzionando",
              tipo: "testo_lungo",
              prompt: "Alla fine del terzo mese guardi gli iscritti. Quanti te ne aspetti, e da quale canale? Poi la parte difficile: a quale numero, in quale data, diresti che questo piano non sta funzionando? E cosa fai il giorno dopo.",
              hint: "«Pochi» non è un numero e «vedremo» non è una data. Il ruolo che si occupa dei corsi ha già scritto quanti allievi paganti servono perché i conti stiano in piedi: parti da quel numero e camminaci dentro — quanti al primo mese, quanti al secondo, quanti da ciascun canale. E la cosa che fai il giorno dopo non può essere «comunichiamo di più»: dev'essere una cosa diversa da quelle che hai già provato.",
              minCaratteri: 350,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "Le ore sono contate e sommate, o restano implicite?",
            "C'è una soglia con un numero E una data, e un'azione diversa da «comunicare di più»?",
          ],
        },
        {
          id: "pitch",
          ...
          sezioni: [
            ...
            {
              id: "la_frase_che_ripetono",
              titolo: "Quello che si dicono fra loro",
              tipo: "testo",
              prompt: "Tre mesi dopo l'apertura, una del rione spiega a un'altra cos'è questo posto. Scrivi la frase che dice davvero — non lo slogan, la frase. E di' quale cosa che avete fatto gliel'ha messa in bocca.",
              hint: "«Una scuola di musica popolare aperta a tutti» non la dice nessuno mai. «'A scuola addò 'o figlio 'e Anna sta 'mparanno 'a chitarra» la dice. La differenza non è di stile: la prima è quello che scrivi tu, la seconda è quello che resta — e resta solo se è successo qualcosa a qualcuno che quelle due conoscono.",
              minCaratteri: 200,
            },
          ],
          reazioneCliente:
          ...
          revisioneFocus: [
            ...
            "È coerente con le tappe precedenti?",
            "Collega la frase a una cosa fatta, non a una qualità della scuola?",
          ],
        },
      ],
    },
