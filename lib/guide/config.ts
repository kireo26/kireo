...
export const GUIDE_PRONTE: Record<string, LivelloGuida[]> = {
  ...
  "salute-professioni-sanitarie": [1, 2],
  "ristorazione-turismo": [1, 2],
  "meccanica-meccatronica": [1, 2],
  "agrifood-ambiente": [1, 2],
  "arte-design-moda": [1, 2],
  "musica-spettacolo": [1, 2],
  "energia-sostenibilita": [1, 2],
  "edilizia-architettura": [1, 2],
  "economia-management": [1, 2],
  "giurisprudenza-pa": [1, 2],
  "mobilita-sostenibile": [1, 2],
  "scienze-educazione": [1, 2],
  "comunicazione-media": [1, 2],
  "scienze-ricerca": [1, 2],
  "sicurezza-difesa": [1, 2],
  "lingue-relazioni-internazionali": [1, 2],
  "studi-umanistici-beni-culturali": [1, 2],
};
